          ...
          <div className="Money-Received-box d-header">
            <div className="money-header">
              ...
              <div className="money-h-middle">
                ...
                <span className="page-count">Score : {question.current_score}/{question.totalQuestion}</span>
          ...
          <div className="mobile_header">
            <div className="mheader">
                ...
                <div className="mfooter">
                  ...
                  <Button type="button" className="check-ans-btn">Check Answer</Button>
